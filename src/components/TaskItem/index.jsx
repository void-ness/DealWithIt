    ...
    return (
        <>
            <div className="taskitem w-full flex items-start my-4">
                ...
                <label className={`text-xl font-light w-60 leading-6 cursor-default relative ${task.checked ? "line-through text-slate-400" : "text-black no-underline"}`} onTouchStart={() => TouchStart(task)} onTouchEnd={TouchEnd}>
                    {task.desc}
